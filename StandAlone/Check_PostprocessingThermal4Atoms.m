...
RunFldr  = "/home/venturi/WORKSPACE/CoarseAIR/N4_UMN/Test/T_20000_20000/Bins_1_1/";
TT       = 20000;%15000;
Velocity = 0.1539899351D-10;%0.1247967544D-10;
...
%            pause
%        end
       TypeATemp                        = ceil(mod(mod(arr_f,16),4))  ;
       TypeA = 2;
       if sum(TypeATemp == [1,2,4]) > 0
          TypeA = 1;
       end
       TypeBTemp                        = (floor(mod(arr_f,16)/4) + 1);
       TypeB = 2;
       if sum(TypeBTemp == [1,2,4]) > 0
          TypeB = 1;
       end
       if TypeA < 1 || TypeA > 2 || TypeB < 1 || TypeB > 2
           pause
